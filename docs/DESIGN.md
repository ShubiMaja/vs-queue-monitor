...
- **Numbers:** Rolling rate, full-session rate, elapsed, ETA, progress percent, and alert firing rules (downward crossings; once per threshold per run; completion ≠ “threshold at 0”).
