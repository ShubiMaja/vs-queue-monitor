...
| **Client panel**        | Monitor icon in topbar opens a panel to set your VS install folder, pick a favourite server, and Connect / Disconnect the game client; optional "in: N min" delay before connecting                                                                               |
